<section id="contador" class="py-4">
    <div class="container">
        <div class="row align-items-center">
            <?php if (isBeforeEventStart()) : ?>
            ...
            <?php else : ?>
                <div class="col-12 col-md-7">
                    <div class="share d-flex justify-content-start">
                        ...
                        <a class="ms-4" href="https://congressoibgc.yazo.app.br/" target="_blank">
                            <img src="<?= get_template_directory_uri() . '/assets/img/aplicativo.png' ?>" alt="Aplicativo" />
                        </a>
                    </div>
                </div>
                <div class="col-12 col-md-5">
