<section id="patrocinadores">
    ...
    <div class="container-fluid">
        ...
        <div class="row ouro">
            <div class="col-12 text-center">
                <h4>Ouro</h4>
                <img src="<?= get_template_directory_uri() . '/assets/img/ouro-b3.png' ?>" alt="B3" />
                <img src="<?= get_template_directory_uri() . '/assets/img/ouro-sebrae.png' ?>" alt="Sebrae" />
                <img src="<?= get_template_directory_uri() . '/assets/img/ouro-vale.png' ?>" alt="VALE" />
            </div>
        </div>
        <div class="row prata">
            <div class="col-12 text-center">
                ...
                <img src="<?= get_template_directory_uri() . '/assets/img/prata-Walking-the-talk.png' ?>" alt="Walking the Talk" />
            </div>
        </div>
